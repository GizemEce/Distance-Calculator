...
def manhattandistance(p1,p2):
	...
	return dist
#test
print manhattandistance((2,3),(5,4))
...
def choosealgorithm():
	userinput=raw_input("If you want to use Manhattan Distance type M,otherwise type E for Euclidean Distance: ")
	...
	if(userinput=="M"):
		print manhattandistance(point1,point2)
	elif(userinput=="E"):
